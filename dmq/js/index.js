...
window.onload = loop;
    ...
    //创造虚拟后台数据
    var arrs = ["邓宇航","裴春瑞","刘茂林","魏靖东","杜彦荣","王荣","毛栋熔","范佳鑫","连英杰","刘阳","刘宏伟","董鹏艳","张淑敏","班照征","丁旭彤","马凤林","陈英","马喜彦","史美婷","王月清","马琳芮","杨奕军","张宇宽","赵家豪","郭宇家","蔚振刚","白炎军","李峰","闫宏杰","王凯奇"];
     //获取父元素
    ...
    btn.onclick = function () {
         if(this.value==="点名"){
            ...
            timeId=setInterval(function () {
                  ...
                  // boxNode.children[11].style.background="red";
              },1);
              this.value="停止";
          }else{
             //清除计时器
